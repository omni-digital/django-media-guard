...
class DownloadableFile(GuardedAsset, models.Model):
    ...
    asset = models.ForeignKey(
        Asset, on_delete=models.CASCADE, related_name="related_files"
    )
    file = models.FileField(upload_to="assets", storage=ProtectedFileSystemStorage())
    name = models.CharField(
        max_length=512, help_text="An internal name for the purposes of searching."
    )
...
class Item(models.Model):
    ...
    description = models.TextField(blank=True, verbose_name="description")
    asset = models.ForeignKey(
        Asset, on_delete=models.CASCADE, related_name="downloadable_files"
    )
